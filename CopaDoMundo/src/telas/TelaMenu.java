...
public class TelaMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gerarGruposAleatorios = new javax.swing.JMenuItem();
        criarGruposManualmente = new javax.swing.JMenuItem();
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/logo2D.png"))); // NOI18N
        ...
        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/seleções/spain_icon_127825.png"))); // NOI18N
        jMenu2.setText("Criar Grupos");
        jMenu2.setFont(new java.awt.Font("Ubuntu Mono", 1, 18)); // NOI18N

        gerarGruposAleatorios.setFont(new java.awt.Font("Ubuntu Mono", 1, 18)); // NOI18N
        gerarGruposAleatorios.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/seleções/portugal_icon_127827.png"))); // NOI18N
        gerarGruposAleatorios.setText("Gerar Grupos Aleatórios");
        gerarGruposAleatorios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gerarGruposAleatoriosActionPerformed(evt);
            }
        });
        jMenu2.add(gerarGruposAleatorios);

        criarGruposManualmente.setFont(new java.awt.Font("Ubuntu Mono", 1, 18)); // NOI18N
        criarGruposManualmente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/seleções/mexico_icon_127947.png"))); // NOI18N
        ...
        jMenu2.add(criarGruposManualmente);
    ...
    private void gerarGruposAleatoriosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gerarGruposAleatoriosActionPerformed
        CriarGruposAleatoriamente gruposAleatorio = new CriarGruposAleatoriamente();
        telaFundo.add(gruposAleatorio);
        gruposAleatorio.setVisible(true);
    }//GEN-LAST:event_gerarGruposAleatoriosActionPerformed
    ...
    private void criarGruposManualmenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarGruposManualmenteActionPerformed
        CriarGruposManualmente gruposManualmente = new CriarGruposManualmente();
        telaFundo.add(gruposManualmente);
        gruposManualmente.setVisible(true);
    ...
    private javax.swing.JMenuItem criarGruposManualmente;
    private javax.swing.JMenuItem gerarGruposAleatorios;
